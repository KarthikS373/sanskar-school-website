...
const Admission = () => {
  return (
    <>
      <div className="relative mx-auto mt-4 grid grid-cols-1 rounded px-2 shadow-lg ring-1 ring-black/25 md:grid-cols-4 md:px-8 lg:grid-cols-6">
        <Image
          src={AdmissionImage}
          alt={"Admission Image"}
      ...
      <div className="flex h-12 flex-row gap-4 bg-[#ffe789] py-2 px-4">
        <Image src={LatestNews} alt="Latest News" className="w-min animate-pulse transition-all" />
        <Marquee pauseOnHover gradient={false} className="h-full grow gap-16" speed={32}>
          <span className="ml-8 border-r border-gray-500/75 pr-8">
            *** Lorem ipsum dolor, sit amet consectetur adipisicing elit. Debitis, consequuntur.
          </span>
          <span className="ml-8 border-r border-gray-500/75 pr-8">
            *** Lorem ipsum dolor, sit amet consectetur adipisicing elit. Debitis, consequuntur.
          </span>
