...
export const ButtonVarients = {
  primary: "bg-orange-500 hover:bg-orange-700 text-white font-bold py-2 px-4 rounded  ",
  secondary: "bg-orange-500 hover:bg-orange-700 text-white font-bold py-2 px-4  ",
  ...
  pill: "h-10 px-5  text-white transition-colors duration-150 bg-orange-500 rounded-full focus:shadow-outline hover:bg-orange-700",
...
const Button = ({
  ...
  return (
    <button
      ...
      disabled={disabled}
      style={style}
      className={`${BASE_CLASS} ${variant && ButtonVarients[variant]} ${className}`}
    >
      {children && children}
