...
const Footer = () => {
  return (
    <footer className="bg-neutral-900/90 text-center text-white">
      <div className="container px-6 pt-6">
        ...
        <div className="mb-6 text-justify md:px-12">
          <p>
            ...
            corrupti dicta, aliquam sequi voluptate quas. Lorem ipsum dolor sit amet, consectetur
            adipisicing elit. Quo perferendis error laudantium praesentium dolore, architecto
            pariatur perspiciatis repellat culpa repudiandae dicta quaerat in officiis magnam
            consequuntur aliquam possimus et reprehenderit ex voluptatum. Dicta delectus animi culpa
            explicabo sapiente accusantium suscipit minus. Debitis culpa dolores iusto?
          </p>
        </div>

        <div className="grid grid-cols-2 md:px-32 lg:grid-cols-4">
          <div className="mb-6 text-left">
            <h5 className="mb-2.5 font-bold uppercase">School Name</h5>
      ...
      <div className="bg-black/25 p-4 text-center text-white/25">
        © 2023 Copyright: {"  "}
